...
class Attendance(models.Model):
    ...
    def operating_time(self):       
        s = timedelta(hours=self.stt_time.hour,minutes=self.stt_time.minute,seconds=self.end_time.second)
        e = timedelta(hours=self.end_time.hour,minutes=self.end_time.minute,seconds=self.end_time.second)
        t = timedelta(hours=self.break_time.hour,minutes=self.break_time.minute,seconds=self.end_time.second)
